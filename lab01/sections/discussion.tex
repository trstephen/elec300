...
\ref{fig:schematics}\subref{fig:vcvs}), we were only receiving a drop in voltage of approximately 6\si{\micro\volt} (peak-to-peak), which implied an internal resistance of approximately 500\si{\micro\ohm}: this was considered to be incorrect.
...
The omp amp was configured so that the output current was 1\si{\milli\ampere} with a 1\si{\kilo\ohm}.
