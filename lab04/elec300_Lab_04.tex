...
\usepackage{
	...
	mathrsfs,			% script letters for Fourier, Laplace; \mathscr{X}
...
% Add a peak-to-peak voltage unit
...
\addbibresource{ELEC300_Lab_04.bib}
...
\newcommand{\LT}{\ensuremath{\mathscr{L}}}
